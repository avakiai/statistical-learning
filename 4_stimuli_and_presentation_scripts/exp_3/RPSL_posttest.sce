...
trial {
	...
	terminator_button = 1;
		picture {
			text { 
				caption = "Let's begin Part 3/4 of the study... \n\n

In this section, you will hear pairs of brief segments of the alien language. \n
...
trial {
	trial_duration = 2000;
		picture {
			text { caption = "Part 3/4 Complete.";
			}; 
			x = 0; y = 0;
		} P_end_exp;
	code = "section_end";
...
string Name_Of_Experiment = "RPSL_posttest";
string section = "posttest";

# Safety
if file_exists(logfile_directory + subj + "_RPSL_posttest.txt") then
...
response_data_file.open(subj + "RPSL_posttest.txt", true);
...
string 		  V_Stim2;
# Response Variables
int       V_subj_resp; # LEFT, RIGHT, DOWN?
double           V_RT; # RT

# Fetch Trial Params
input_file Randomization = new input_file;
Randomization.open(rand + "_tempo_post_lang_A.txt");
